...
describe('testAutoListing', () => {
  ...
  test('handleListingContractUpdated owner or ZERO_ADDRES AutoListing', () => {
    const lastUpdate = BigInt.fromI32(1623430500)
    createAutoListing(AutoListingFirstFixture)
    ...
    assert.entityCount('AutoListing', 1)
    assert.entityCount('PriceDetail', 0)
  })
